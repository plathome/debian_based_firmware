...
)
{
	...
	/* RTW_INFO("==>phy_BB8812_Config_ParaFile\n"); */
	...
	/* RTW_INFO(" ===> phy_BB8812_Config_ParaFile() phy_reg:%s\n",pszBBRegFile); */
	/* RTW_INFO(" ===> phy_BB8812_Config_ParaFile() phy_reg_pg:%s\n",pszBBRegPgFile); */
	/* RTW_INFO(" ===> phy_BB8812_Config_ParaFile() agc_table:%s\n",pszAGCTableFile); */
...
)
{
	...
	/* RTW_INFO("===> PHY_GetTxPowerIndex_8812A\n"); */
...
)
{
	...
	/* RTW_INFO("[BW:CHNL], phy_PostSetBwMode8812(), set BW=%s !!\n", GLBwSrc[pHalData->CurrentChannelBW]); */
