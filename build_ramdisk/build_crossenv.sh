...
packages="build-essential uboot-mkimage libncurses5-dev libc6-armel-cross libc6-dev-armel-cross binutils-arm-linux-gnueabi gcc-4.7-arm-linux-gnueabi zlib1g-dev-armel-cross vim"
